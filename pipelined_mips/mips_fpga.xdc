...
set_property -dict {PACKAGE_PIN T8 IOSTANDARD LVCMOS33} [get_ports {switches[8]}];  # Switch 7

set_property -dict {PACKAGE_PIN H6 IOSTANDARD LVCMOS33}  [get_ports {switches[9]}];  # Switch 4
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports {switches[10]}];  # Switch 5
set_property -dict {PACKAGE_PIN U11 IOSTANDARD LVCMOS33} [get_ports {switches[11]}];  # Switch 6
set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports {switches[12]}];  # Switch 7

set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS33} [get_ports {switches[13]}];  # Switch 7
